    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_outside:
                    "day-outside text-muted-foreground aria-selected:text-muted-foreground bg-transparent opacity-50",
                day_disabled: "text-muted-foreground opacity-50",
                day_range_middle: "aria-selected:bg-bright-gray aria-selected:text-accent-foreground",
