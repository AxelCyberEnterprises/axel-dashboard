...
const PitchSessionReport: React.FC = () => {
    ...
    return (
        <div className="py-4 text-primary-blue">
            <section className="px-4 md:px-8 border-b-1">
            ...
            <section className="px-4 md:px-8 py-4">
                <div className="flex flex-wrap w-full items-stretch">
                    <div className="w-full lg:w-7/12 lg:pe-2">
                    ...
                    <div className="w-full lg:w-5/12 lg:ps-2 flex flex-col justify-between h-full">
                        <div className="border-1 rounded-xl p-4">
                        ...
                        <div className="mt-4 border-1 rounded-xl px-4 py-6">
            ...
            <section className="px-4 lg:px-8 py-4">
                <div className="border-1 rounded-xl py-5 px-4">
                    ...
                    <div className="flex flex-wrap">
                        <div className="pe-2 w-full md:w-1/2">
                        ...
                        <div className="ps-2 w-full md:w-1/2">
                            <div className="border-1 rounded-xl py-5 px-3">
                ...
                <div className="border-1 rounded-lg py-5 px-4 mt-4">
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-full md:w-1/2 pe-2">
