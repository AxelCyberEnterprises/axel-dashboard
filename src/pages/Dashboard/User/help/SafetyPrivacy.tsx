        ...
        <div>
            <section className="w-full border-y flex flex-col items-start text-[#262b3a] px-7 py-2 gap-2 ">
               <button className="bg-transparent text-black flex gap-1  hover:bg-transparent p-0 justify-start text-sm items-center" onClick={() => navigate(-1)}>
                ...
                <svg width="17" height="18" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
...
<p className='my-2.5'>By using our platform, you acknowledge that you have read, understood, and agreed to this User-Level Agreement (ULA), which governs your access and use of our AI-powered public speaking and presentation practice environment.</p>
<p className='my-1.5'>By clicking “I Agree” and providing your initials, you confirm your acceptance of these terms.</p>
<ol className='list-decimal'>

<li className='my-12'>
    <span className="mb-2">Introduction</span>
<p className='my-2'>Welcome to EngageX! By using our platform, you acknowledge that you have read, understood, and agreed to this User-Level Agreement (ULA), which governs your access and use of our AI-powered public speaking and presentation practice environment.</p>
<p className='my-2'>By clicking “I Agree” and providing your initials, you confirm your acceptance of these terms.</p>
</li>
...
<li className='my-12'>
     <span className="mb-2">Confidentiality of Personal Data</span>
...
<p className="my-2">By using EngageX, you waive the right to frivolous lawsuits or claims seeking damages beyond platform usage fees.</p>
</li>
</ol>
            </main>
                </article>
